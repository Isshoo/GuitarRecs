 ...
 * Get guitar by ID
 */
const getGuitarById = async (req, res, next) => {
  try {
    const { id } = req.params;
 ...
 */
const createGuitar = async (req, res, next) => {
  try {
 ...
 */
const updateGuitar = async (req, res, next) => {
  try {
    const { id } = req.params;
    const { name, brand, type, bodyType, strings, price, imageUrl } = req.body;
 ...
 */
const deleteGuitar = async (req, res, next) => {
  try {
    const { id } = req.params;
 ...
 */
const getUnratedGuitarsByUser = async (req, res, next) => {
  try {
